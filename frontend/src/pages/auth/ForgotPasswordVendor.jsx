// src/pages/auth/ForgotPasswordVendor.jsx
...
export default function ForgotPasswordVendor() {
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      // Rediriger vers la page de connexion vendor après 2 secondes
      setTimeout(() => {
              ...
              <form onSubmit={handleSubmitEmail}>
                <div className="mb-6">
                  ...
                  <div className="relative group">
                    <EnvelopeIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400 group-focus-within:text-emerald-500 transition-colors" />
                    <input
                      type="email"
                      value={email}
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    Entrez l'email associé à votre compte vendeur
                  </p>
                </div>
                  ...
                  <div className="text-center">
                    {timer > 0 ? (
                      ...
                      <button
                        ...
                        className="text-sm font-medium text-emerald-600 hover:text-emerald-700 hover:underline transition-colors disabled:text-gray-400 disabled:cursor-not-allowed"
                      >
                        Renvoyer le code
                      </button>
                    )}
              ...
              <form onSubmit={handleResetPassword}>
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="relative group">
                      <LockClosedIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-400 group-focus-within:text-emerald-500 transition-colors" />
                      <input
